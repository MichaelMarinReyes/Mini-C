...
export type StartRuleNames = "inicio";
export interface ParseOptions<T extends StartRuleNames = "inicio"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"inicio">>(
  input: string,
  options?: Options,
): any;
