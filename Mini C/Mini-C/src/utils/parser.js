...
function peg$parse(input, options) {
  ...
  var peg$e1 = peg$literalExpectation("nombre_proyecto", false);
  var peg$e2 = peg$literalExpectation(":", false);
  var peg$e3 = peg$literalExpectation("\"", false);
  var peg$e4 = peg$literalExpectation("main", false);
  var peg$e5 = peg$literalExpectation(".cmm", false);
  ...
  var peg$e13 = peg$otherExpectation("WS");
  var peg$e14 = peg$classExpectation([" ", "\t", "\r", "\n"], false, false);

  var peg$f0 = function(contenido) {
        return { salida: salida, error: errorSalida, symTable: memoria };
    };
  var peg$f1 = function(np, main, mods) {
        return {
            nombre_proyecto: np,
            main: main,
            modulos: mods
  ...
  function peg$parseinicio() {
    ...
    s0 = peg$currPos;
    s1 = peg$parse_();
    s2 = peg$parseestructuraYAML();
    if (s2 !== peg$FAILED) {
      s3 = peg$parse_();
      s4 = [];
      s5 = peg$parsecomentario();
      while (s5 !== peg$FAILED) {
        s4.push(s5);
        s5 = peg$parsecomentario();
      }
  ...
  function peg$parsemoduloBloque() {
  ...
  function peg$parsearchivoModulo() {
